...
char n_min[120],n_max[120];
void generate_smaller_number(int m,int s)
{
ms(n_min,'0');
int i=m-1;
int sum=s-1;
...
void generate_larger_number(int m,int s)
{
ms(n_max,'0');
int i=0;
int sum=s;
...
{
 generate_smaller_number(m,s);
generate_larger_number(m,s);
print(m);    
}         
 return 0;   
}    
