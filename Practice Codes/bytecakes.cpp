...
int main()
{
	...
	while(1)
	{
		...
		if(e==-1)
		break;
	d=(double)e/(double)e1;
if(d<(double)f/(double)f1)
d=(double)f/(double)f1;

if(d<(double)s/(double)s1)
d=(double)s/(double)s1;
if(d<(double)m/(double)m1)
d=(double)m/(double)m1;
//printf("%lf\n",d*e1-e);

printf("%lf %lf %lf %lf\n",round(d*e1-e),round(d*f1-f),round(d*s1-s),round(d*m1-m));
