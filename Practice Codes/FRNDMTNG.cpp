...
double incl,excl1,total,ans,excl2;
ll T1,T2,t1,t2;
int main()
{
	tests
...
if(T1>t2)
{
excl1=0.5*(T1-t2)*(T1-t2);
	if(T1>t2+T2)
	{
		excl1-=0.5*(T1-t2-T2)*(T1-t2-T2);
	}

}
 if(T2>t1)
{
excl2=0.5*(T2-t1)*(T2-t1);
	if(T2>t1+T1)
	{
		excl2-=0.5*(T2-t1-T1)*(T2-t1-T1);
	}

}
incl=total-excl1-excl2;
ans=incl/total;
printf("%lf\n",ans);
	}
	return 0;
