...
int main()
{
	int c1,c2,c3,c4,n,m,a[1002],b[1005];
	get2(c1,c2);
	get2(c3,c4);
	get2(n,m);
	gl(i,0,n)
...
int initial_total_suma=suma,initial_total_sumb=sumb;
if(suma>c3)
initial_total_suma=c3;
if(sumb>c3)
initial_total_sumb=c3;
int total_sum=c4,initial_total_sum=initial_total_suma+initial_total_sumb;
if(initial_total_sum<total_sum)
total_sum=initial_total_sum;
put1n(total_sum);
	return 0;
}
