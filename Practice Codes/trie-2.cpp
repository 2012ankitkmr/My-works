...
tst*InsertInTST(tst*root,char *word)
{
if(root==NULL)
{
	root=(tst*)malloc(sizeof(tst));
	root->data=*word;
	root->is_End_String=1;
...
int SearchInTSTRecursive(tst*root,char *word)
{
if(!root)
return -1;
