...
#define ull long long //data types used often, but you don't want to type them time by time
#define ll unsigned long long
#define ui unsigned int
#define us unsigned short
#define IOS ios_base::sync_with_stdio(0); //to synchronize the input of cin and scanf
#define MODu (long long int)1e9
...
b=b%MOD;
c=c%MOD;
		ll result1=FastPower(b,c,MOD-1);
		result1=result1%(MOD-1);
	if (c==0)
		{
		printf("%lld\n",a%MOD);
		continue;
...
if(a%MOD==0)
	{
		...
		ll result2=FastPower(a,result1,MOD);
		printf("%lld\n",result2);
	}
	return 0;
}
